...
$string['hidereveal'] = 'Hide option for authors to reveal themselves';
$string['hidereveal_help'] = 'If checked, then the authors will not be able to reveal themselves';
